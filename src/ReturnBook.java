...
public class ReturnBook extends JFrame {
	...
	public ReturnBook() {
		...
		JLabel lblBookSerialNo = new JLabel("Book SerialNo:");
		...
		btnReturnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String bookSerialNo=textField.getText();
				int studentid=Integer.parseInt(textField_1.getText());
				int i=ReturnBookDao.delete(bookSerialNo, studentid);
				if(i>0){
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
						...
						.addComponent(lblBookSerialNo, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))
					.addGap(56)
